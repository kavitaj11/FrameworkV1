...
SearchDataPropertyFile data = new SearchDataPropertyFile();
	...
	public HGHProductsDetailsPageObjects addDifferentQuantity(String quantity) throws InterruptedException {
		Thread.sleep(3000);
	...
	public HGHProductsDetailsPageObjects clickOnAddToCart() throws Exception {
	...
	public HGHProductsDetailsPageObjects verifyProductTitle(String productTitle)
	{
		Waiting.explicitWaitVisibilityOfElement(productTitleLocator, 10);
	...
	public HGHProductsDetailsPageObjects verifyProductDetailsPage(String searchText) throws Exception {
	...
	public HGHProductsDetailsPageObjects verifyProductTitleHasTheFilterChosen(String filterName) {
		Waiting.explicitWaitVisibilityOfElement(productTitleLocator, 10);
