...
public class HGHOrderConfirmationPageObjects extends MainController {
	...
	public HGHOrderConfirmationPageObjects verifyConfirmOrderPage() throws Exception{
	...
	public HGHOrderConfirmationPageObjects verifyOrderStatus() throws Exception{
