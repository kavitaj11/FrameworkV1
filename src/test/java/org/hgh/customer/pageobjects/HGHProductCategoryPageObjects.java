 ...
 */
public class HGHProductCategoryPageObjects extends MainController{
   ...
   Actions action = new Actions(driver);
	...
	public HGHProductCategoryPageObjects errorScenarios(String expectedMsg) {
	...
	public HGHProductCategoryPageObjects assertForErrorMessages(String expectedMsg) {
		Assert.assertEquals(errorMsgLocator.getText().trim(),expectedMsg,errorMsgLocator.getText().trim()+" is displayed");
		return this;
	}

	public HGHProductCategoryPageObjects logout() {
		logoutButton.click();
		return this;
	}
	
	public HGHProductCategoryPageObjects verifyDisplayOfLoginLink(){
	...
	public HGHProductCategoryPageObjects searchText(String searchText) throws Exception {
	...
	public HGHProductCategoryPageObjects verifyDisplayOfMyAccountsInHeader() {
		Assert.assertTrue(myAccountInHeader.isDisplayed(), "My Account link is not displayed");
		return this;
	}

	public HGHProductCategoryPageObjects verifyDisplayOfOrderStatusInHeader() {
		Assert.assertTrue(orderStatusLinkHeader.isDisplayed(), "Order Status link is not displayed");
		return this;
	}

	public HGHProductCategoryPageObjects verifyDisplayOfOrderPadInHeader() {
		Assert.assertTrue(orderPadLinkHeader.isDisplayed(),"order pad link is not displayed");
		return this;
	}

	public HGHProductCategoryPageObjects verifyResourcesLinkInHeader() {
		
		Assert.assertTrue(resourcesLinkHeader.isDisplayed(), "resources link is not displayed");
	return this;
	}

	public HGHProductCategoryPageObjects verifyHelpLinkHeader() {
		Assert.assertTrue(helpLinkHeader.isDisplayed(), "help link is not displayed");
		return this;
	}

	public HGHProductCategoryPageObjects verifyHeadingOfEverySectionInFooter() throws Exception {
	...
	public HGHProductCategoryPageObjects verifyTabFocus() {
		focusTab.isDisplayed();
		return this;
		
	}

	public HGHProductCategoryPageObjects waitForLogoutLink() {
