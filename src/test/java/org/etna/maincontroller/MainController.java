...
import org.etna.customer.pageobjects.ShoppingCartPageObjects;
...
public ShoppingCartPageObjects shoppingCartPage()
{
	ShoppingCartPageObjects shoppingCartPage = PageFactory.initElements(driver,ShoppingCartPageObjects.class);
